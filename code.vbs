Private Sub Document_Open()
   ...
   ActiveDocument.Range.Text = "Pafish for Office Macro v1, by Joe Security" & vbCrLf & vbCrLf & "Includes latest in-the-wild evasion checks. Developed to test and improve sandboxes!" & vbCrLf
...
Public Sub checkZoneIdentifier()
    ...
    If CreateObject("Scripting.FileSystemObject").FileExists(ThisDocument.Path & Application.PathSeparator & ThisDocument.Name) Then
